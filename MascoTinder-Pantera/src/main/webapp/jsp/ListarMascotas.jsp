...
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/estilosListarMascota.css">
			...
			<div class="mascota">
				...
				<div class="description col-12 col-lg-8 ">
					<div class="row">
						<div class="col-12">
							<div class=" m-2">
								<span class="nombreMascota float-left">Nombres</span>
							</div>
